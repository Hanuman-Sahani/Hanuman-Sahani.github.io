...
document.getElementById("whatsAppForm").addEventListener("submit", function(e) {
  ...
  // Build the WhatsApp message (using %0A for line breaks)
  var text = "Name: " + name + "%0AEmail: " + email + "%0AMobile: " + mobile + "%0AMessage: " + message;
  
  // Construct the WhatsApp URL (replace '1234567890' with your WhatsApp number)
  var url = "https://api.whatsapp.com/send?phone=7651864655&text=" + text;
